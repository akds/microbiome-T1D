...
b = importdata('filtered_sorted_otu_table_gg_taxon_L6.txt');
...
exp1_chow_data_index = startsWith(exp1_data_ids,'Chow.F','IgnoreCase',true) | startsWith(exp1_data_ids,'KO.F','IgnoreCase',true)
...
x3 = startsWith(exp1_data_ids(bit),'Chow.F','IgnoreCase',true) | startsWith(exp1_data_ids(bit),'KO.F','IgnoreCase',true)
